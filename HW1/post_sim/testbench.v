...
module testbench();
    ...
    initial $sdf_annotate("/MasterClass/StudentID_HDL/HW1/gate_level/adder_structure/Delay/adder_structure.sdf", adder1);
    initial $sdf_annotate("/MasterClass/StudentID_HDL/HW1/gate_level/adder_structure_reg/Delay/adder_structure_reg.sdf", adder_reg_1);

    initial $sdf_annotate("/MasterClass/StudentID_HDL/HW1/gate_level/adder_dataflow/Delay/adder_dataflow.sdf", adder2);
    initial $sdf_annotate("/MasterClass/StudentID_HDL/HW1/gate_level/adder_dataflow_reg/Delay/adder_dataflow_reg.sdf", adder_reg_2);

    initial $sdf_annotate("/MasterClass/StudentID_HDL/HW1/gate_level/adder_behavior/Delay/adder_behavior.sdf", adder3);
    initial $sdf_annotate("/MasterClass/StudentID_HDL/HW1/gate_level/adder_behavior_reg/Delay/adder_behavior_reg.sdf", adder_reg_3);
